...
<head>
    ...
    <title>pak-kumis - KantinNusa</title>
...
<section class="hero-store">
    ...
    <div class="hero-content text-center" data-aos="zoom-in">
        <span class="badge bg-primary mb-3 px-4 py-2 rounded-pill shadow-lg animate__animated animate__fadeInDown">
            <i class="fas fa-crown me-1 text-warning"></i> Legend Sejak 1998
        </span>
        
        <h1 class="display-3" style="font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 800; letter-spacing: -1px;">
            Bakso <span style="color: var(--gold-nusa);">Pak Kumis</span>
        </h1>
        
        <p class="lead fw-bold opacity-90">
            <i class="fas fa-motorcycle me-2 text-warning"></i>
            Area Parkir <span class="badge bg-light text-dark ms-1" style="font-size: 0.7rem; vertical-align: middle;">Samping Gerbang</span>
        </p>
    </div>
</section>
   ...
   <div class="container py-5">
    ...
    <div class="mb-5" data-aos="fade-up">
        <h3 class="section-title" style="color: #d63384; border-left: 5px solid #d63384; padding-left: 15px;">Menu Utama Pak Kumis</h3>
        <div class="row g-4">
            <div class="col-6 col-md-4 col-lg-3">
                <div class="card menu-item-card">
                    <div class="img-container">
                        <span class="badge-promo bg-danger text-white">BESTSELLER</span>
         <img src="{{ asset('images/bakso aci.jpg') }}" alt="bakso aci">
                    </div>
                    <div class="p-3">
                        <h6 class="fw-bold mb-1 text-truncate">Bakso Aci Ori</h6>
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="card menu-item-card">
                    <div class="img-container">
                   <img src="{{ asset('images/bakso alus.jpg') }}" alt="bakso alus">
                    </div>
                    <div class="p-3">
                        <h6 class="fw-bold mb-1 text-truncate">Bakso kecil alus</h6>
                        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="card menu-item-card">
                    <div class="img-container">
                        <<img src="{{ asset('images/mercon.jpg') }}" alt="bakso mercon">
                    </div>
                    <div class="p-3">
                        <h6 class="fw-bold mb-1 text-truncate">Bakso Mercon Pedas</h6>
                        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="card menu-item-card">
                    <div class="img-container">
                        <span class="badge-promo bg-warning text-dark">NEW</span>
                        <img src="{{ asset('images/aym suwir.jpg') }}" alt="bakso ayam suwir">
                    </div>
                    <div class="p-3">
                        <h6 class="fw-bold mb-1 text-truncate">Bakso Aci Ayam Suwir</h6>
                        <div class="d-flex justify-content-between align-items-center mb-3">
     ...
     <div class="mb-5" data-aos="fade-up">
        <h3 class="section-title" style="color: #fd7e14; border-left: 5px solid #fd7e14; padding-left: 15px;">perlengkapan mantap</h3>
        <div class="row g-4">
            <div class="col-6 col-md-4 col-lg-3">
                <div class="card menu-item-card">
                    <div class="img-container">
                   <img src="{{ asset('images/kerupuk.jpg') }}" alt="krupuk">
                    </div>
                    <div class="p-3">
                        <h6 class="fw-bold mb-1 text-truncate">Kerupuk Putih</h6>
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <span class="price-tag">Rp 2.000</span>
                            <div class="rating-chip">
                                <i class="fas fa-star"></i>
                                <span>5.0</span>
                            </div>
  ...
  <div class="col-6 col-md-4 col-lg-3">
                <div class="card menu-item-card">
                    <div class="img-container">
                        <img src="{{ asset('images/tahu.jpg') }}" alt="tahu">
                    </div>
                    <div class="p-3">
                        <h6 class="fw-bold mb-1 text-truncate">Tahu Putih</h6>
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <span class="price-tag">Rp 5.00</span>
                            <div class="rating-chip">
                                <i class="fas fa-star"></i>
                                <span>4.8</span>
                            </div>
                ...
                <div class="card menu-item-card">
                    <div class="img-container">
                       <img src="{{ asset('images/bakso tahu.jpg') }}" alt="bakso tahu">
                    </div>
                    <div class="p-3">
                        <h6 class="fw-bold mb-1 text-truncate">Tahu Coklat</h6>
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <span class="price-tag">Rp 5.00</span>
                            <div class="rating-chip">
                                <i class="fas fa-star"></i>
              ...
              <div class="col-6 col-md-4 col-lg-3">
                <div class="card menu-item-card">
                    <div class="img-container">
                        <img src="https://images.unsplash.com/photo-1629978665195-46395170463c?auto=format&fit=crop&w=400" alt="Bakso Telur">
                    </div>
                    <div class="p-3">
                        <h6 class="fw-bold mb-1 text-truncate">Goreng Pangsit</h6>
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <span class="price-tag">Rp 5.00</span>
                            <div class="rating-chip">
                                <i class="fas fa-star"></i>
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="card menu-item-card">
                    <div class="img-container">
                        <img src="https://images.unsplash.com/photo-1541518763669-27fef04b14ea?auto=format&fit=crop&w=400" alt="Gorengan">
                    </div>
                    <div class="p-3">
                        <h6 class="fw-bold mb-1 text-truncate">Siomay </h6>
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <span class="price-tag">Rp 5.00</span>
                            <div class="rating-chip">
                                <i class="fas fa-star"></i>
    ...
    <div class="mb-5" data-aos="fade-up">
        ...
        <div class="row g-4">
            <div class="col-6 col-md-4 col-lg-3">
                <div class="card menu-item-card">
                    <div class="img-container">
                        ...
                        <img src="https://images.unsplash.com/photo-1556679343-c7306c1976bc?auto=format&fit=crop&w=400" alt="Es Teh">
                    </div>
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="card menu-item-card">
                    <div class="img-container">
                        <img src="https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?auto=format&fit=crop&w=400" alt="Es Jeruk">
                    </div>
                    <div class="p-3 text-center">
