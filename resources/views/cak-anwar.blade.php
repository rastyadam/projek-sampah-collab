...
<head>
    ...
    <title>Mie Ayam Cak Anwar - KantinNusa</title>
    ...
    <style>
        :root { 
            --maroon-nusa: #e67e22; /* Diubah ke Orange Mie Ayam */
            --maroon-light: #d35400;
            --gold-nusa: #ffc107;
            --bg-light: #f8f9fa;
        }
        ...
        .hero-store {
            ...
            background: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.8)), 
                        url('https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?auto=format&fit=crop&w=1200');
   ...
   <section class="hero-store">
    ...
    <div class="hero-content text-center" data-aos="zoom-in">
        ...
        <p class="lead opacity-75 fw-bold">
            ...
            Kantin Belakang <span class="badge bg-danger ms-1" style="font-size: 0.7rem;">Area Perpus</span>
        </p>
    </div>
</section>
    ...
    <div class="container py-5">
        ...
        <div class="mb-5" data-aos="fade-up">
            <h3 class="section-title">Menu Utama Mie</h3>
            <div class="row g-4">
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card menu-item-card">
                        <div class="img-container">
                            <span class="badge-promo bg-danger text-white">LEGENDARIS</span>
                             <img src="{{ asset('images/mieayam.jpg') }}" alt="sempol ayam">
                        </div>
                        <div class="p-3">
                            <h6 class="fw-bold mb-1 text-truncate">Mie Ayam Biasa</h6>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span class="price-tag">Rp 17.000</span>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card menu-item-card">
                        <div class="img-container">
                            <span class="badge-promo bg-warning text-dark">BESTSELLER</span>
                            <img src="{{ asset('images/mieayambkso.jpg') }}" alt="Mie Ayam Bakso">
                        </div>
                        <div class="p-3">
                            <h6 class="fw-bold mb-1 text-truncate">Mie Ayam Bakso</h6>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card menu-item-card">
                        <div class="img-container">
                            <img src="{{ asset('images/ceker.jpg') }}" alt="Mie Ayam Ceker">
                        </div>
                        <div class="p-3">
                            <h6 class="fw-bold mb-1 text-truncate">Mie Ayam Ceker</h6>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card menu-item-card">
                        <div class="img-container">
                            <img src="https://images.unsplash.com/photo-1569718212165-3a8278d5f624?auto=format&fit=crop&w=400" alt="Mie Ayam Komplit">
                        </div>
                        <div class="p-3">
                            <h6 class="fw-bold mb-1 text-truncate">Mie Pangsit</h6>
                            <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="mb-5" data-aos="fade-up">
            <h3 class="section-title">Minuman Dingin</h3>
            <div class="row g-4">
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card menu-item-card">
                        <div class="img-container">
                            <span class="badge-promo bg-success text-white">FRESH</span>
                              <img src="{{ asset('images/ess teh.jpg') }}" alt="sempol ayam">
                        </div>
                        <div class="p-3 text-center">
                            <h6 class="fw-bold mb-1">Es Teh Manis</h6>
                            <div class="d-flex justify-content-center align-items-center gap-3 mb-2">
                                <p class="price-tag mb-0">Rp 3.000</p>
                                <div class="rating-chip">
                                    <i class="fas fa-star"></i>
                                    <span>4.9</span>
                                </div>
...
<section class="container mb-5" data-aos="fade-up">
    <div class="row mb-4">
        <div class="col-12">
            <h3 class="section-title">Review Anak SMKN 1</h3>
        </div>
    </div>
    ...
    <div class="row g-4">
        <div class="col-md-4">
            <div class="review-card p-4 shadow-sm border-0 bg-white" style="border-radius: 25px;">
                <div class="d-flex align-items-center mb-3">
                    <img src="https://i.pravatar.cc/150?u=siswa1" class="rounded-circle me-3" width="45" height="45" alt="User">
                    <div>
                        <h6 class="fw-bold mb-0" style="font-size: 0.9rem;">Dimas Saputra</h6>
                        <small class="text-muted" style="font-size: 0.75rem;">Siswa XII TKJ</small>
                    </div>
                </div>
                ...
                <p class="mb-0 text-muted" style="font-size: 0.85rem; line-height: 1.6;">
                    "Paling suka kalau lagi laper banget ke Cak Anwar. Porsinya banyak, kuahnya gurih pol. Mie ayam paling recommended di sekolah!"
                </p>
                <hr class="opacity-10">
        ...
        <div class="col-md-4">
            <div class="review-card p-4 shadow-sm border-0 bg-white" style="border-radius: 25px;">
                <div class="d-flex align-items-center mb-3">
                    <img src="https://i.pravatar.cc/150?u=siswa2" class="rounded-circle me-3" width="45" height="45" alt="User">
                    <div>
                        <h6 class="fw-bold mb-0" style="font-size: 0.9rem;">Siska Amelia</h6>
                        <small class="text-muted" style="font-size: 0.75rem;">Siswi XI BDP</small>
                    </div>
                </div>
                <div class="mb-2 text-warning" style="font-size: 0.8rem;">
                    <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                ...
                <p class="mb-0 text-muted" style="font-size: 0.85rem; line-height: 1.6;">
                    "Cekernya lembut banget, dipretelin nggak susah. Harganya juga pas di kantong pelajar. Sukses terus Cak!"
                </p>
                <hr class="opacity-10">
                <div class="d-flex align-items-center text-success" style="font-size: 0.7rem; font-weight: 700;">
                    <i class="fas fa-check-circle me-1"></i> PEMBELI TERVERIFIKASI
...
<div class="modal fade" id="successModal" tabindex="-1" aria-hidden="true">
    ...
    <footer class="text-center py-5 bg-white border-top">
        <div class="container">
            ...
            <p class="text-muted small">Solusi makan praktis di lingkungan sekolah.<br>&copy; 2026 Mie Ayam Cak Anwar - SMKN 1 Purwosari</p>
        </div>
    </footer>
